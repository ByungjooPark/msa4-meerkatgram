...
public enum CustomResponseCode {
    ...
    , ALREADY_REGISTERED_ERROR(HttpStatus.CONFLICT, "E02") // v1에서는 미사용 (OAuth2 전용)
    ...
    // OAuth2 관련
    , OAUTH2_ERROR(HttpStatus.CONFLICT, "E30") // v1에서는 미사용 (OAuth2 전용)
    , UNSUPPORTED_PROVIDER_ERROR(HttpStatus.CONFLICT, "E31") // v1에서는 미사용 (OAuth2 전용)
    // File 관련
